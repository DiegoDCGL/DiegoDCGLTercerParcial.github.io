    ...
    if (count($errors) == 0) {
        if (emailExiste($email, $con)) {
            ...
            if ($token !== null) {
                ...
                $asunto = "Recuperar Contraseña - Maquinados y Automatizaciones";
                $cuerpo = "Estimado $nombres: <br> Si has solicitado reestablecer tu contraseña da clic en el siguiente enlace <a href='$url'>$url</a>.";
                $cuerpo .= "<br>Si no realizaste esta solicitud puedes ingnorar este correo.";

                if ($mailer->enviarEmail($email, $asunto, $cuerpo)) {
                    echo "<p><b>Correo enviado</b></p>";
                    echo "<p>Hemos enviando un correo electrónico a $email para restablecer la contraseña.</p>";
...
<body class="d-flex flex-column h-100">
    ...
    <!-- Contenido -->
    <main class="form-login m-auto col-12 col-md-6 col-lg-4">
